...
| [`html/`](html/) | 24 份实验分析与设计图解报告，直接用浏览器打开；英文版在 [`html/en/`](html/en/) |
...
| [WALL-MOUNT-OPEN.md](docs/WALL-MOUNT-OPEN.md) | 地-墙过渡（P5，进行中）**当前状态与待决**：摩擦上墙路线与已定规则、几何规律结论、机器常数与实测定律、机身沉降的系统解法提案、代码地图、待决清单 |
| [WALL-MOUNT-HISTORY.md](docs/WALL-MOUNT-HISTORY.md) | 地-墙过渡归档（09-06~09-13 原 OPEN 全文）：吸附扶梯路线、规划器序列、E1~E6 逐次实机记录与原因分析、参数表的“为什么” |
