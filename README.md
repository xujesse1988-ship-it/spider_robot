...
| 文件 | 用途 |
|---|---|
| `left-tibia-suction.stl` | 吸盘足 v3：与 MakeYourPet left-tibia **一体化**的小腿（替代 left-tibia.stl + 旧吸盘足，腿短约 59mm）。末端腔体按实购"2.5 折吸盘+双六角螺母+直角宝塔"一体件（`images/xipan_marked.jpeg`）做全形状负模：Ø27 折痕锥 → Ø15 凹槽凸筋 → 六角袋锁转动 → 弯头腔。打印 3 件（右腿版待生成） |
