...
| 文件 | 用途 |
|---|---|
| `suction_foot.stl` | 吸盘足模块 v2：套接 MakeYourPet 腿末端 9×9mm 方轴（顶丝锁紧）。底部卡槽从侧面卡住吸盘颈部（Ø17×5 / Ø15×1.5 凹槽 / Ø17×2，实购 2.5 折波纹吸盘+直角宝塔一体件，见 `images/xipan.jpg`），C 型护筒正面开窗供滑入和出气管。打印 6 件 |
| `component_plate.stl` | M3 网格安装板，固定真空泵/电磁阀/传感器 |

打印建议：PETG 或 PLA，4 壁、40% 填充；`suction_foot` 卡槽底面朝下打印无需支撑（护筒开窗顶部有一次约 20mm 桥接，正常打印机可过）。
